...
const Satellite = createLucideIcon("satellite", __iconNode$a);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function DashboardSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "dashboard", className: "py-24 relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 pointer-events-none",
        style: {
          background: "radial-gradient(ellipse 80% 50% at 50% 50%, oklch(0.85 0.18 195 / 0.04) 0%, transparent 70%)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 reveal-on-scroll", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl font-bold uppercase text-foreground mb-4", children: [
          "Your ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Command Center" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "A unified dashboard giving you complete visibility of every order, every shipment, in real-time." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            ...
            boxShadow: "0 8px 40px oklch(0.85 0.18 195 / 0.08), 0 2px 8px oklch(0.08 0.02 258 / 0.5)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: "app.supplyblock.io/dashboard"
                    }
                  )
                ]
              }
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-2 py-3 mb-3", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: "w-6 h-6 rounded flex items-center justify-center",
                              style: {
                                background: "linear-gradient(135deg, oklch(0.75 0.2 195), oklch(0.55 0.22 258))"
                              },
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              ...
                              children: "SupplyBlock"
                            }
                          )
                        ] }),
                        [
                          { icon: ChartColumn, label: "Overview", active: true },
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-5 overflow-auto", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "p",
                          {
                            ...
                            children: "Live shipment monitoring"
                          }
                        )
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Search orders..." })
                          ]
                        }
                      ) })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-3 mb-5", children: [
                      {
                        label: "Active Orders",
                        value: "1,247",
                        change: "+12%",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                                ...
                                style: { color: "oklch(0.95 0.01 258)" },
                                children: "Order #SB-20841 — Journey"
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-0", children: [
                            {
                              icon: Package,
                              label: "Factory",
                              sub: "Mar 18",
                          ...
                          ].map((stage, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center flex-1", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "div",
                                {
                                  ...
                                  style: {
                                    background: stage.done ? "oklch(0.85 0.18 195 / 0.1)" : "oklch(0.15 0.03 258)",
                                    border: stage.active ? "2px solid oklch(0.85 0.18 195)" : stage.done ? "1px solid oklch(0.85 0.18 195 / 0.4)" : "1px solid oklch(0.6 0.04 258 / 0.3)",
                                    boxShadow: stage.active ? "0 0 10px oklch(0.85 0.18 195 / 0.3)" : "none"
                                  },
                                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    stage.icon,
                                    {
                                      className: "w-4 h-4",
                                      style: {
                                        color: stage.done ? "oklch(0.85 0.18 195)" : "oklch(0.6 0.04 258 / 0.5)"
                                      }
                                    }
                                  )
                                }
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "span",
                                {
                                  ...
                                  style: {
                                    color: stage.done ? "oklch(0.9 0.01 258)" : "oklch(0.6 0.04 258 / 0.5)"
                                  },
                            ...
                            idx < 3 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                                ...
                                style: {
                                  background: idx < 2 ? "linear-gradient(90deg, oklch(0.85 0.18 195), oklch(0.6 0.22 258))" : "linear-gradient(90deg, oklch(0.85 0.18 195 / 0.25), transparent)",
                                  boxShadow: idx < 2 ? "0 0 4px oklch(0.85 0.18 195 / 0.3)" : "none"
                                }
                              }
                            )
                          ] }, stage.label)) }),
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "div",
                              {
                                ...
                                children: [
                                  ...
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.85 0.18 195)" }, children: "72%" })
                                ]
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                                ...
                                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "div",
                                  {
                                    ...
                                    style: {
                                      width: "72%",
                                      background: "linear-gradient(90deg, oklch(0.85 0.18 195), oklch(0.6 0.22 258))",
...
function FeaturesSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "features", className: "py-24 relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 pointer-events-none",
        style: {
          background: "radial-gradient(ellipse 80% 60% at 50% 50%, oklch(0.85 0.18 195 / 0.03) 0%, transparent 70%)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal-on-scroll", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "inline-block text-xs font-semibold tracking-widest uppercase px-3 py-1 rounded mb-4",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl font-bold uppercase text-foreground mb-4", children: [
          ...
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Take Control" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "A full-stack platform combining AI intelligence with blockchain security for unmatched supply chain visibility." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: features.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(f.icon, { className: "w-6 h-6", style: { color: f.color } })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold text-foreground mb-3", children: f.title }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "neon-line mb-10" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 lg:grid-cols-5 gap-10 mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold gradient-text", children: "SupplyBlock" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                style: { color: "oklch(0.6 0.04 258)" },
                children: "Revolutionizing global supply chains through AI intelligence and blockchain-verified transparency."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3", children: socials.map(({ icon: Icon2, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                "aria-label": label,
                ...
                onMouseEnter: (e) => {
                  ...
                  e.currentTarget.style.color = "oklch(0.85 0.18 195)";
                  e.currentTarget.style.boxShadow = "0 0 10px oklch(0.85 0.18 195 / 0.3)";
                },
                onMouseLeave: (e) => {
                  e.currentTarget.style.borderColor = "oklch(0.85 0.18 195 / 0.2)";
                  e.currentTarget.style.color = "oklch(0.6 0.04 258)";
          ...
          Object.entries(links).map(([category, items2]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h4",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: items2.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                onMouseLeave: (e) => {
                  e.currentTarget.style.color = "oklch(0.55 0.04 258)";
                },
                children: item
              }
            ) }, item)) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.85 0.18 195)" }, children: "Presented by Piyush and Subham" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    onMouseLeave: (e) => {
                      e.currentTarget.style.color = "oklch(0.65 0.25 290)";
                    },
...
function FutureScopeSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "future", className: "py-24 relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 pointer-events-none",
        style: {
          background: "radial-gradient(ellipse 80% 60% at 50% 50%, oklch(0.65 0.25 290 / 0.04) 0%, transparent 70%)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal-on-scroll", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl font-bold uppercase text-foreground mb-4", children: [
          "The Road ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Ahead" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "We are just getting started. Here's what SupplyBlock is building next." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: items$1.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: "w-6 h-6", style: { color: item.color } })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold text-foreground mb-3 pr-12", children: item.title }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            background: "linear-gradient(135deg, oklch(0.85 0.18 195 / 0.06), oklch(0.65 0.25 290 / 0.06))",
            border: "1px solid oklch(0.85 0.18 195 / 0.2)",
            boxShadow: "0 4px 30px oklch(0.85 0.18 195 / 0.06)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-2xl sm:text-3xl font-bold uppercase text-foreground mb-4", children: [
              "Ready to Transform Your",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Supply Chain" }),
              "?"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-8 max-w-lg mx-auto", children: "Join the future of transparent, AI-powered logistics. Start your free trial today." }),
...
function Header() {
  ...
  const headerClass = scrolled ? "bg-background/95 backdrop-blur-md border-b border-border shadow-sm" : "bg-transparent";
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 py-4 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold tracking-tight gradient-text", children: "SupplyBlock" })
          ] }),
        ...
        mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden bg-background/98 backdrop-blur-md border-t border-border px-6 py-4 flex flex-col gap-3", children: [
...
function HeroSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 hero-glow" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "absolute top-1/4 left-1/4 w-96 h-96 rounded-full pointer-events-none",
            style: {
              background: "radial-gradient(circle, oklch(0.65 0.25 290 / 0.06) 0%, transparent 70%)",
              filter: "blur(60px)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 lg:gap-16 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fadeInLeft", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight mb-6 uppercase", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "Revolutionizing" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Supply Chains" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "with AI &" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg leading-relaxed mb-8 max-w-lg", children: "Track, compare, and optimize your orders in real-time. Powered by AI intelligence and secured by immutable blockchain technology." }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-8 mt-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex items-center justify-center animate-fadeInRight", children: /* @__PURE__ */ jsxRuntimeExports.jsx(HeroViz, {}) })
        ] }) })
      ]
    }
  );
...
function HeroViz() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-lg aspect-square", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 rounded-full animate-glow-pulse",
        style: {
          background: "radial-gradient(circle, oklch(0.85 0.18 195 / 0.06) 0%, transparent 70%)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "SupplyBlock AI Blockchain Visualization" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("radialGradient", { id: "globeGrad", cx: "50%", cy: "50%", r: "50%", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "stop",
                {
                  offset: "0%",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("radialGradient", { id: "coreGrad", cx: "50%", cy: "50%", r: "50%", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "stop",
                {
                  offset: "0%",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("filter", { id: "glow-strong", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "200", cy: "200", r: "80", fill: "url(#globeGrad)" }),
          latitudeOffsets.map((offset) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "ellipse",
            {
              cx: "200",
              cy: 200 + offset,
          ...
          longitudeAngles.map((angle) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "ellipse",
            {
              cx: "200",
              cy: "200",
          ...
          circuitLines.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "line",
              {
                x1: l.x1,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: l.nx, cy: l.ny, r: "2.5", fill: "oklch(0.85 0.18 195)" })
          ] }, `${l.nx}-${l.ny}`)),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "g",
            {
...
function HowItWorksSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "how-it-works", className: "py-24 relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 pointer-events-none",
        style: {
          background: "radial-gradient(ellipse 70% 40% at 50% 60%, oklch(0.65 0.25 290 / 0.04) 0%, transparent 70%)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal-on-scroll", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl font-bold uppercase text-foreground mb-4", children: [
          "Four Simple ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Steps" }),
          " to Clarity"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "From onboarding to real-time insights — SupplyBlock gets you up and running in minutes." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative reveal-on-scroll", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:flex items-start gap-0", children: steps.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-start flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center w-full mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            i < steps.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "step-connector mx-2" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full pr-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold text-foreground mb-2", children: step.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: step.desc })
          ] })
        ] }) }, step.num)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden flex flex-col gap-8", children: steps.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
...
function ProblemSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "problem", className: "py-24 relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 pointer-events-none",
        style: {
          background: "radial-gradient(ellipse 80% 50% at 50% 50%, oklch(0.65 0.25 290 / 0.04) 0%, transparent 70%)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal-on-scroll", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl font-bold uppercase text-foreground mb-4", children: [
          "Why Supply Chains Are ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Broken" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "The global supply chain industry is plagued by systemic failures that cost businesses trillions every year." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: problems.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(p.icon, { className: "w-6 h-6", style: { color: p.color } })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-foreground mb-3", children: p.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: p.desc })
          ]
        },
        p.title
      )) })
...
function SmartSupportSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "support", className: "py-24 relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 pointer-events-none",
        style: {
          background: "radial-gradient(ellipse 60% 40% at 50% 50%, oklch(0.85 0.18 195 / 0.03) 0%, transparent 70%)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal-on-scroll", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "Smart Support"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl font-bold uppercase text-foreground mb-4", children: [
          "Intelligent ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Support" }),
          " That Never Sleeps"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "Our AI support layer proactively monitors, detects, and resolves issues before they impact your business." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold text-foreground mb-3", children: item.title }),
...
function SolutionSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "solution", className: "py-24 relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 pointer-events-none",
        style: {
          background: "radial-gradient(ellipse 70% 50% at 30% 50%, oklch(0.85 0.18 195 / 0.04) 0%, transparent 70%)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-16 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal-on-scroll", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "inline-block text-xs font-semibold tracking-widest uppercase px-3 py-1 rounded mb-4",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl font-bold uppercase text-foreground mb-5", children: [
          "Powered by ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "AI + Blockchain" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-8 leading-relaxed", children: "SupplyBlock is the world's first AI-powered blockchain supply chain platform that gives every stakeholder complete, real-time transparency — from manufacturer to consumer." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-4", children: points.map((point) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            CircleCheck,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: point })
        ] }, point)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center items-center reveal-on-scroll reveal-delay-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldViz, {}) })
    ] }) })
  ] });
}
function ShieldViz() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-80 h-80", children: [
    ringIndices.map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(135deg, oklch(0.85 0.18 195 / 0.08), oklch(0.65 0.25 290 / 0.1))",
              border: "1px solid oklch(0.85 0.18 195 / 0.3)",
              boxShadow: "0 4px 30px oklch(0.85 0.18 195 / 0.15), inset 0 0 20px oklch(0.85 0.18 195 / 0.05)"
            },
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Shield,
              {
    ...
    chainNodes.map((node, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background font-sans overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(SmartSupportSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FutureScopeSection, {})
    ] }),
...
function normalizeZ(c, points2) {
  const invertedZs = FpInvertBatch(c.Fp, points2.map((p) => p.Z));
  return points2.map((p, i) => c.fromAffine(p.toAffine(invertedZs[i])));
}
...
function validateMSMPoints(points2, c) {
...
function pippenger(c, fieldN, points2, scalars) {
  validateMSMPoints(points2, c);
  validateMSMScalars(scalars, fieldN);
  const plength = points2.length;
  ...
  for (let i = lastBits; i >= 0; i -= windowSize) {
    ...
    for (let j = 0; j < slength; j++) {
      ...
      buckets[wbits2] = buckets[wbits2].add(points2[j]);
    }
    let resI = zero;
...
function edwards(params, extraOpts = {}) {
  ...
  class Point {
    ...
    static normalizeZ(points2) {
      return normalizeZ(Point, points2);
    }
    static msm(points2, scalars) {
      return pippenger(Point, Fn, points2, scalars);
    }
...
Service({
  ...
  "getSiteInfo": Func(
    [],
    [Record({ "tagline": Text, "companyName": Text })],
    ["query"]
  )
});
